...
A3Com to zestaw modułów Perla pozwalających na konfigurowanie switchy
LAN firmy 3Com: SuperStack II 3900/9300 i CoreBuilder 3500. Aktualnie
moduły te mogą używać interfejsu SNMP lub telnet do:
- wypisania tablic ARP
- wypisania tablic bridgingu
- wyszukiwania adresów MAC, IP lub nazw hostów
- zmiany haseł administratora w trybie wsadowym
- zapisywania i odtwarzania konfiguracji switchy po SNMP
- przesyłania nowego firmware'u po SNMP (w trybie wsadowym)
- zbierania dotyczących poszczególnych portów informacji takich jak
...
- przechowywania globalnej historii ARP jako połączonej bazy danych.
